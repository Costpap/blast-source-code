...
var embed = new Discord.RichEmbed()
    ...
    .addField(`**${botconfig.prefix}kill** <user>`, `Kill someone with a random Minecraft string inserted.`, true)
    .addField(`**${botconfig.prefix}mock** <user>`, `Mock someone. (Thank 275268619838160896)`, true)
